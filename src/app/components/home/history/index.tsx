      ...
      <div className="container lg:max-w-screen-xl md:max-w-screen-md dark:text-black mx-auto grid grid-cols-1 lg:grid-cols-12 py-40">
        ...
        >
          <p className="text-4xl text-midnight_text dark:text-white mb-8 font-bold">
            Modernstructura History <br />
            How we became number one
          </p>
          <p className="mb-8 pb-2 text-gray">
            We began with a vision to redefine housing through quality and
            trust. By consistently delivering prime locations and exceptional
            customer service, we built lasting relationships. Today, that
            commitment has made us the number one choice in property and housing
          </p>
          <Link
