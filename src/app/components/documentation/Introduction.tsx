         ...
         {docNavbarOpen && (
          <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-40" onClick={() => setDocNavbarOpen(false)} />
            ...
            <button onClick={() => setDocNavbarOpen(true)} className="p-0"> <Icon icon="gg:menu-right" className="text-3xl lg:hidden block" /></button>
              ...
              <div className="mt-5">
               <p className="text-base font-medium text-midnight_text dark:text-gray">Modernstructura</p>
               <p className="text-base font-medium text-midnight_text dark:text-gray">Ready</p>
               <p className="text-base font-medium text-midnight_text dark:text-gray">Customization</p>
               </div>
