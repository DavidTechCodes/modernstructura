...
export default function AdvanceSearch({ category }: { category?: string }) {
  ...
  const filteredProperties = category
    ? properties.filter(
        (data: any) => normalize(data.category) === normalize(category)
      )
    : properties;
  ...
  return (
    <>
      <HeroSub
        ...
        description="Our Properties List showcases a wide range of homes and developments designed to meet diverse needs. From modern apartments to spacious family houses, each property is carefully selected for quality, location, and value."
      ...
      <section className="dark:bg-darkmode px-4">
        <div className="lg:max-w-screen-xl max-w-screen-md mx-auto">
          ...
          <div
            onClick={toggleOffCanvas}
            className={`fixed inset-0 top-0 w-full h-full bg-gray-900 bg-opacity-50 z-50 transition-transform transform ${
          ...
          <div className="lg:grid lg:grid-cols-12 gap-4">
            ...
            <div className="col-span-12 lg:col-span-8">
              <div className="flex lg:flex-nowrap flex-wrap lg:gap-0 gap-6 w-full justify-between items-center pb-8">
                ...
                <div className="flex-1 flex gap-3 px-4">
                  ...
                  <button
                    ...
                    } p-3 border border-primary text-primary hover:text-white rounded-lg hover:bg-primary text-base`}
                  >
                    <span>
                      <Icon
                        icon="famicons:list"
              ...
              {filteredProperties.length > 0 ? (
                ...
                >
                  {(sortOrder ? sortedProperties : properties).map(
                    (data: any, index: any) => (
                      <PropertyCard
                        key={index}
                        property={data}
                ...
                <div className="flex flex-col gap-5 items-center justify-center pt-20">
                  <Image
                    src={getImgPath("/images/not-found/no-results.png")}
                    alt="no-result"
                    width={100}
                    height={100}
                  />
