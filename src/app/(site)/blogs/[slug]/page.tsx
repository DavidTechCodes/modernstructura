                    ...
                    <div className="grid md:grid-cols-12 grid-cols-1 items-center">
                        <div className="col-span-8">
                            <div className="flex flex-col sm:flex-row">
                                ...
                                <span className="text-base text-midnight_text font-medium dark:text-white sm:pl-7 pl-0 w-fit">0 Comments</span>
                            </div>
                        ...
                        <div className="flex items-center md:justify-center justify-start gap-6 col-span-4 pt-4 md:pt-0">
                            ...
                            />
                            <div className="">
                                <span className="text-[22px] leading-[1.2] font-bold text-midnight_text dark:text-white">David A.</span>
